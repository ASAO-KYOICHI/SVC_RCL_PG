            ...
            if (CSEQTS >= 60) {
                ...
                if (CCSEQ != 15) {
                    ...
                    if (RTIMM >= 60) {
                        ...
                        RTIMH2 = (uint16_t)(REG_00 >> 8);/* 上位セット */
